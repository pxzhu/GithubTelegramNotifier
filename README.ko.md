...
![아키텍처](./docs/images/architecture-overview.svg)
...
![텔레그램 설정](./docs/images/telegram-setup-checklist.svg)
...
![클라우드플레어 설정](./docs/images/cloudflare-setup-checklist.svg)
...
![깃허브 앱 설정](./docs/images/github-app-setup-checklist.svg)
...
## 4) 알림 검증 순서
![검증 플로우](./docs/images/verification-flow.svg)
